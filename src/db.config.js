...
export const pool = mysql.createPool({
  host: process.env.DB_HOST || 'hrr-db.cxmyw68wckv9.ap-northeast-2.rds.amazonaws.com', // mysql의 hostname
  user: process.env.DB_USER || 'admin', // user 이름
  port: process.env.DB_PORT || 3306, // 포트 번호
  database: process.env.DB_NAME || 'hrr_db', // 데이터베이스 이름
  password: process.env.DB_PASSWORD || 'HrrBE1234!', // 비밀번호
